...
# Fix working directory for .pyw execution
...
class MainMenu:
    ...
    def show_settings_dialog(self):
        ...
        tk.Label(info_frame, text="âœ¨ Running Modular Architecture", 
        ...
        try:
            ...
            modules_status.append("âœ… Core System")
        except:
            modules_status.append("âŒ Core System")
            
        try:
            from travel import TravelSystem
            modules_status.append("âœ… Travel System")
        except:
            modules_status.append("âŒ Travel System")
            
        try:
            from generation import OllamaClient
            modules_status.append("âœ… AI Generation")
        except:
            modules_status.append("âŒ AI Generation")
            
        try:
            from rendering import HexMapRenderer
            modules_status.append("âœ… Renderer")
        except:
            modules_status.append("âŒ Renderer")
